  ...
  return (
    <div className="max-w-2xl mx-auto p-5">
      ...
      <div className='mx-auto w-fit py-5 min-w-[150px]'>
        <button
          className="bg-brand-green text-white p-3 rounded-md hover:opacity-90 w-full"
      ...
      <div className='mx-auto w-fit min-w-[150px]'>
        <form action="/auth/signout" method="post">
          <button className="bg-red-400 text-white p-3 rounded-md hover:opacity-90 w-full" type="submit">
            Sign out
          </button>
        </form>
      </div>
